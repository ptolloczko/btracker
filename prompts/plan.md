...
<project_description>
Blood tracker is a web application that allow users to manualy write his records, i want in this mvp one page with form and submit. Users can see list of his records and can edit, delete.
</project_description>
